    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="w-64 border-r border-gray-200 flex flex-col h-full">
        ...
        <nav className="flex-1">
          <ul className="space-y-2 px-3 justify-between flex flex-col h-full">
            ...
            <div className="mb-10">
              ...
              <HoverCard>
                ...
                <HoverCardContent
                  ...
                  className="bg-red-500 text-white shadow-xl rounded-xl max-w-2xl px-20 py-2 w-full"
                >
                  <Button className="cursor-pointer text-left p-0 bg-red-500 text-white">
                    Logout
                  </Button>
                </HoverCardContent>
              </HoverCard>
